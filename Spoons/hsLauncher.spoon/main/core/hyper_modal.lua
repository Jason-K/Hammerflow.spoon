...
local Indicator = require('hsLauncher.main.core.indicator')
local HotkeyManifest = require('hsLauncher.main.core.hotkey_manifest')
local ExitKeys = require('hsLauncher.main.core.exit_keys')
local application = require('hs.application')
local ax = require('hs.axuielement')
local canvas = require('hs.canvas')     -- For GUI
local geometry = require('hs.geometry') -- For GUI
local ModeSpec = require('hsLauncher.main.core.mode_spec')
local Engine = require('hsLauncher.main.core.input_engine')
local LeaderBuffer = require('hsLauncher.main.core.leader_buffer')
...
function M.enterMode(name, key_actions)
	local modal_gui = require('hsLauncher.main.core.modal_gui') -- Lazy load
