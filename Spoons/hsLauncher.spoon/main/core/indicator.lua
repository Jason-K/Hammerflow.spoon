-- Canvas-based on-screen indicator (avoids menubar)
...
local function ensureCanvas(self)
	...
	c[2] = { type = 'text', text = 'Hy', textFont = 'Helvetica-Bold', textSize = self.fontSize, textColor = { white = 1, alpha = 1 }, frame = { x = 8, y = 4, w = r.w - 16, h = r.h - 8 }, textAlignment =
	'center' }
